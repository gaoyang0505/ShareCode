...
<body>
					...
					<div class="sidebar portfolio-sidebar">
						<div class="sidebar-item categories">
							...
							<ul class="nav navbar-stacked">
								<li class="active"><a href="createAgent.htm" target="content">Create Agent</a></li>
								<li><a href="createCompany.htm" target="content">Create Company</a></li>
								<li><a href="browserAgent.htm" target="content">Update Agent</a></li>
							</ul>
						</div>
					</div>
				</div>
	...
	<script type="text/javascript" src="/project/resources/js/jquery.isotope.min.js"></script>
	<script type="text/javascript" src="/project/resources/js/lightbox.min.js"></script>
